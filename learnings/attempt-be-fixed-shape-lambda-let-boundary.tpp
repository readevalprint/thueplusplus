...
# Attempt BE: fixed-shape parsed-surface lambda/let adapters.
# These are intentionally a boundary probe, not the final architecture: they prove
# parser/value composition for the hard matrix but do not implement generic
# lexical EV/RET/APPLY yet.
