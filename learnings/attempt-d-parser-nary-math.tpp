...
# Innermost binary reductions. N-ary add/mul reduce first two args and keep rest.
^E\[(?<pre>$PCT)LIST%28ATOM%3Aadd%20NUM%3A(?<a>$NUM)%20NUM%3A(?<b>$NUM)%20(?<rest>.+)%29%20(?<post>$PCT)\]$ ::= E[{{pre}}LIST%28ATOM%3Aadd%20NUM%3AADD[{{a}},{{b}}]%20{{rest}}%29%20{{post}}]
^E\[(?<pre>$PCT)LIST%28ATOM%3Amul%20NUM%3A(?<a>$NUM)%20NUM%3A(?<b>$NUM)%20(?<rest>.+)%29%20(?<post>$PCT)\]$ ::= E[{{pre}}LIST%28ATOM%3Amul%20NUM%3AMUL[{{a}},{{b}}]%20{{rest}}%29%20{{post}}]
...
^E\[(?<pre>$PCT)LIST%28ATOM%3Aadd%20NUM%3A(?<a>$NUM)%20%29%20(?<post>$PCT)\]$ ::= E[{{pre}}NUM%3A{{a}}%20{{post}}]
^E\[(?<pre>$PCT)LIST%28ATOM%3Amul%20NUM%3A(?<a>$NUM)%20%29%20(?<post>$PCT)\]$ ::= E[{{pre}}NUM%3A{{a}}%20{{post}}]
^E\[(?<pre>$PCT)LIST%28ATOM%3Asub%20NUM%3A(?<a>$NUM)%20NUM%3A(?<b>$NUM)%20%29%20(?<post>$PCT)\]$ ::= E[{{pre}}NUM%3ASUB[{{a}},{{b}}]%20{{post}}]
