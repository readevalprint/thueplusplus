...
.PHONY: test build/thuepp wasm wasm-smoke wasm-adapter-test demo-test demo-build challenge-check challenge-test
...
test: build/thuepp
	...
	cd go && go test ./...
	uv run --with pytest pytest tools/test_cli_input_file.py tools/test_cli_export_state.py tools/test_lisp_cgi_script.py tools/test_example_runner.py tools/test_submission_automerge.py tools/test_metrics_parity.py tools/test_python_template_cache.py tools/test_command_pipe_resources.py -q --tb=short
