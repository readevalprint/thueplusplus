...
^W:<|P|>\{\* <N>(?<a>[^<]+)</N> <N>(?<b>[^<]+)</N>\}<|Q|>\n<|R|> ::= W:{{p}}<N>@MUL[{{a}}|{{b}}]@</N>{{q}}\n{{r}}
^W:<|P|>\{/ <N>(?<a>[^<]+)</N> <N>(?<b>[^<]+)</N>\}<|Q|>\n<|R|> ::= W:{{p}}<N>@DIV[{{a}}|{{b}}]@</N>{{q}}\n{{r}}
@ADD\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! add a b
@SUB\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! sub a b
@MUL\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! mul a b
@DIV\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! div a b
...
@NUMEQ\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! numeq a b
@LT\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! lt a b
@GT\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! gt a b
@LE\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! le a b
@GE\[(?<a>-?[0-9]+(?:\.[0-9]+)?)\|(?<b>-?[0-9]+(?:\.[0-9]+)?)\]@ ::! ge a b
^W:(?<p>[^\n]*)@B:1@(?<q>[^\n]*)\n<|R|> ::= W:{{p}}<T/>{{q}}\n{{r}}
^W:(?<p>[^\n]*)@B:0@(?<q>[^\n]*)\n<|R|> ::= W:{{p}}<F/>{{q}}\n{{r}}
