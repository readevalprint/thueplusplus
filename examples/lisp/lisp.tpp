...
^QQLIST<L<unquote>(?: (?<rest>[^|]*))?\|(?<env>[^|]*)\|(?<k>.*)\|(?<acc>(?:[^;>]*;)*)>$ ::= QQESC<unquote|list||{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQLIST<L<unquote%20(?<args>$PCT)>(?: (?<rest>[^|]*))?\|(?<env>[^|]*)\|(?<k>.*)\|(?<acc>(?:[^;>]*;)*)>$ ::= QQESC<unquote|list|{{args}}|{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQLIST<L<splice>(?: (?<rest>[^|]*))?\|(?<env>[^|]*)\|(?<k>.*)\|(?<acc>(?:[^;>]*;)*)>$ ::= QQESC<splice|list||{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQLIST<L<splice%20(?<args>$PCT)>(?: (?<rest>[^|]*))?\|(?<env>[^|]*)\|(?<k>.*)\|(?<acc>(?:[^;>]*;)*)>$ ::= QQESC<splice|list|{{args}}|{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQLIST<L<quasiquote(?:%20(?<args>$PCT))?>(?: (?<rest>[^|]*))?\|(?<env>[^|]*)\|(?<k>.*)\|(?<acc>(?:[^;>]*;)*)>$ ::= QQESC<quasiquote|list|{{args}}|{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQESC<unquote\|top\|\|\|(?<env>[^|]*)\|> (?<k>.*)>$ ::= ERR<wrong_arity>
^QQESC<unquote\|top\|(?<expr>(?:[A-Za-z0-9_.-]|%[0-1][0-9A-F]|%2[1-9A-F]|%[3-9A-F][0-9A-F])*)%20(?<extra>$PCT)\|\|(?<env>[^|]*)\|> (?<k>.*)>$ ::= ERR<wrong_arity>
...
^QQESC<unquote\|list\|\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ERR<wrong_arity>
^QQESC<unquote\|list\|(?<expr>(?:[A-Za-z0-9_.-]|%[0-1][0-9A-F]|%2[1-9A-F]|%[3-9A-F][0-9A-F])*)%20(?<extra>$PCT)\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ERR<wrong_arity>
^QQESC<unquote\|list\|(?<expr>$PCT)\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ARGENV<{{expr|pctdec}}|{{env}}|KQQITEM<{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQESC<splice\|list\|\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ERR<wrong_arity>
^QQESC<splice\|list\|(?<expr>(?:[A-Za-z0-9_.-]|%[0-1][0-9A-F]|%2[1-9A-F]|%[3-9A-F][0-9A-F])*)%20(?<extra>$PCT)\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ERR<wrong_arity>
^QQESC<splice\|list\|(?<expr>$PCT)\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ARGENV<{{expr|pctdec}}|{{env}}|KQQSPLICE<{{rest}}|{{env}}|{{acc}}> {{k}}>
^QQESC<quasiquote\|list\|(?<args>$PCT)\|(?<rest>[^|]*)\|(?<env>[^|]*)\|(?<acc>(?:[^;>]*;)*)> (?<k>.*)>$ ::= ERR<unsupported_form>
