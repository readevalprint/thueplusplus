...
const columns: ColumnDef<ChallengeSolution>[] = [
  {
    accessorKey: 'author',
...
function sortButton(column: Column<ChallengeSolution, unknown>, label: string) {
...
function openSolution(solution: ChallengeSolution, event: MouseEvent | KeyboardEvent): void {
